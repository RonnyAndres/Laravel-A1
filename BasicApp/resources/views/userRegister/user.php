...
<head>
    ...
    <!-- Path: public/css/userRegister/user.css -->
    <style>
...
<body>
    <div class="wrapper">
        <div class="form-left">
            ...
            <p>
            This app manages users and provides functionalities for registration, login, and profile management. However, it is not currently connected to MySQL. Users can create an account, update their profile information, and administrators can manage user accounts. Future updates will integrate with a database for secure data storage and retrieval.            </p>
